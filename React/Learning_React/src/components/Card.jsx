...
function Card() {
    const data = [
        // { image: 'https://images.unsplash.com/photo-1633174524778-61a18ee54490?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTZ8fGFtYXpvbnxlbnwwfHwwfHx8MA%3D%3D', name: "Amazon", description: "lorem ipsum, fafem nfai najn njaffn nfewib dfj " },
        // { image: 'https://images.unsplash.com/photo-1654573817889-296cad084c97?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8ZmxpcGthcnR8ZW58MHx8MHx8fDA%3D', name: "Flipkart", description: "lorem ipsum, fafem nfai najn njaffn nfewib dfj " },
        // { image: 'https://images.unsplash.com/photo-1653389527532-884074ac1c65?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8em9tYXRvfGVufDB8fDB8fHww', name: "Zomato", description: "lorem ipsum, fafem nfai najn njaffn nfewib dfj " },
        // { image: 'https://images.unsplash.com/photo-1612810806695-30f7a8258391?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MzZ8fGFwcCUyMGxvZ298ZW58MHx8MHx8fDA%3D', name: "Tesla", description: "lorem ipsum, fafem nfai najn njaffn nfewib dfj " },
